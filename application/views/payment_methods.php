...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Métodos de Pagamento</h1>
		</div>
	</div><!--/.row-->
					...
					<div class="row" style="padding-bottom: 15px;">
						<div class="col-md-6">
							<a href="<?=base_url()?>setting/add_payment_method" style="text-decoration: none;">
								<button type="button" class="btn btn-primary">Inserir Novo Método de Pagamento</button>
							</a>
						</div>
