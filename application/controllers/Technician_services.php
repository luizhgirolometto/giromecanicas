...
class Technician_services extends CI_Controller
{
    ...
    public function tech_opened_services()
    {
        ...
        if ($page == 0) {
            ...
            $sh_text = "Exibindo $start_point até ".count($data['results']).'de '.$this->Technicianservices_model->record_opened_count().' registros';
        } else {
            $start_sh = $page + 1;
            $end_sh = $page + count($data['results']);
            $sh_text = "Exibindo $start_sh até $end_sh de ".$this->Technicianservices_model->record_opened_count().' registros';
        }
    ...
    public function tech_requested_inventory_services()
    {
        ...
        if ($page == 0) {
            ...
            $sh_text = "Exibindo $start_point até ".count($data['results']).' de '.$this->Technicianservices_model->record_requested_material_count().' registros';
        } else {
            $start_sh = $page + 1;
            $end_sh = $page + count($data['results']);
            $sh_text = "Exibindo $start_sh até $end_sh de ".$this->Technicianservices_model->record_requested_material_count().' registros';
        }
    ...
    public function tech_drew_out_inventory_services()
    {
        ...
        if ($page == 0) {
            ...
            $sh_text = "Exibindo $start_point até ".count($data['results']).' de '.$this->Technicianservices_model->record_drew_out_material_count().' registros';
        } else {
            $start_sh = $page + 1;
            $end_sh = $page + count($data['results']);
            $sh_text = "Exibindo $start_sh até $end_sh de ".$this->Technicianservices_model->record_drew_out_material_count().' registros';
        }
    ...
    public function tech_completed_services()
    {
        ...
        if ($page == 0) {
            ...
            $sh_text = "Exibindo $start_point até ".count($data['results']).' de '.$this->Technicianservices_model->record_completed_service_count().' registros';
        } else {
            $start_sh = $page + 1;
            $end_sh = $page + count($data['results']);
            $sh_text = "Exibindo $start_sh até $end_sh de ".$this->Technicianservices_model->record_completed_service_count().' registros';
        }
